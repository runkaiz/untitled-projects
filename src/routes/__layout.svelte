...
<div class="min-h-screen flex">
				...
				<div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
					...
					<nav class="mt-5 flex-1" aria-label="Sidebar">
						<div class="px-2 space-y-1">
							<a
								href="/updates"
								class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors group flex items-center px-2 py-2 text-sm font-medium rounded-md"
							>
								<!-- Heroicon name: outline/status-online -->
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="text-gray-400 group-hover:text-gray-500 transition-colors mr-3 h-6 w-6"
									fill="none"
									viewBox="0 0 24 24"
									stroke="currentColor"
								>
							...
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="text-gray-500 h-6 w-6 mr-3"
									fill="none"
									viewBox="0 0 24 24"
									stroke="currentColor"
								>
	...
	<div class="flex flex-col min-w-0 flex-1 overflow-hidden">
		<!-- Top nav bar for toggling menu on mobile devices. -->
		<div class="lg:hidden">
			<div
