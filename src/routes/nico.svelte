...
<MainPanel>
	...
	<div class="flex flex-row">
		<div class="basis-full border border-gray-200 rounded-md p-4 my-6">
			...
			<p class="pt-2 text-gray-700">
                I am still compiling and designing what is going to be placed inside this section, so bear with me for now.
			</p>
		</div>
	</div>
	<div>
		<ProjectTable title="Ongoing Projects" subtitle="A list of projects that I recently worked on." buttonLink="https://github.com/runkaiz" buttonText="GitHub">
			<Project name="Untitled Project" platform="Web" language="HTML, CSS, JS" status="Ongoing" link="https://github.com/runkaiz/untitled-projects" />
			<Project name="Shift C" platform="Web" language="HTML, CSS, JS" status="Planning" link="https://github.com/yych42/shift-c" />
		</ProjectTable>
		<br />
		<ProjectTable title="Other Projects" subtitle="Relevent programs that I had been working that may not be as recent. Those that are marked as experiments are like completed little proofs of concepts. Practically they are not useful to anybody, but I have always found these snippets of knowledge handy as I tend to forget things." buttonLink="https://github.com/runkaiz" buttonText="GitHub">
			...
			<Project name="Journey" platform="iOS" language="Swift" status="Experiment" link="https://github.com/runkaiz/Journey" />
			<Project name="Heartful" platform="iOS" language="Swift" status="Experiment" link="https://github.com/runkaiz/Heartful" />
		</ProjectTable>
	</div>
</MainPanel>
