<form action="#" class="relative">
	<div
		class="border border-gray-300 px-3 rounded-lg shadow-sm overflow-hidden focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500"
	>
	...
	<div class="absolute bottom-0 inset-x-px">
		...
		<div class="flex flex-nowrap justify-end py-2 px-2 space-x-2 sm:px-3">
            ...
            -->
              ...
              -->
						<li
							class="bg-white cursor-default select-none relative py-2 px-3"
							id="listbox-option-0"
							role="option"
						>
							<div class="flex items-center">
								...
								<span class="ml-3 block font-medium truncate"> Unassigned </span>
							</div>
						</li>
						...
						>
							<div class="flex items-center">
								<img
									...
									class="flex-shrink-0 h-5 w-5 rounded-full"
								/>
								<span class="ml-3 block font-medium truncate"> Wade Cooper </span>
							</div>
						</li>
